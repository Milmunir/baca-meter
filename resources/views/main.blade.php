...
class jadoel di public/css/style_new.css bagian @media min-width: 768px) --}}
    <div class="container">
      <div class="row px-2">
        <div class="container d-none d-md-block pb-2 shadow my-2 rounded pt-md-2 Jadoel">
          <div class="row">
...
{{-- numbering berdasarkan berapa kali loop berjalan (iterasi) dimulai dari 1 --}}
              ...
              <div class="col-8 mx-md-auto align-self-center">
                <div class="row">
              ...
              <div class="col-2 my-auto mx-auto col-md-2 px-md-1">
